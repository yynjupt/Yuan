...
if __name__ == '__main__':
    ...
    input_name = r"D:\黑龙江火灾\Yuan\b1.csv"
    ...
    x_train, y_train, x_test, y_test = seq2seq.load_data(data, seq_len, feature_num, predict_num, percent)

    ################################ 包含注意力机制的编码器-解码器模型 #####################################
    # 建立模型
    print('(2)building model...')
    model = seq2seq.build_attention_model(seq_len, feature_num)  # 建立神经网络
